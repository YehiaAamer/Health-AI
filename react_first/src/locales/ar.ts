...
allReports: "كل التقارير",
 weekly: "أسبوعي",
  ...
  report: {
    ...
    disclaimerText:
      "هذا التقرير مبدئي فقط ولا يُعد تشخيصًا طبيًا نهائيًا. يرجى مراجعة طبيب متخصص لإجراء تقييم دقيق وفحوصات إضافية.",
    ...
    noAdditionalMessage: "لا توجد ملاحظات إضافية.",
  ...
  help: {
    ...
    faqs: {
      aiDiagnosis: {
        ...
        answer:
          "لا، HealthAI أداة ذكية تساعد في تقديم مؤشرات أولية ومعلومات مبدئية بناءً على الأعراض، لكنه لا يغني عن استشارة الطبيب."
      },
      dataSecurity: {
  ...
  footer: {
    ...
    terms: "شروط الخدمة",
    contact: "دعم العملاء",
    copyright: "© 2026 HealthAI. جميع الحقوق محفوظة."
  },
  ...
  landing: {
    ...
    testimonialsSubtitle: "قصص حقيقية من مرضى وأطباء يثقون في HealthAI.",
    testimonial1Text:
      '"لقد أحدث HealthAI ثورة في ممارستي الطبية. فهو يقدم رؤى سريعة وموثوقة، مما يجعل التشخيص أسرع لمرضاي."',
...
latestDeletedReport: "آخر تقرير محذوف",
  ...
  terms: {
    ...
    title: "شروط الخدمة",
    subtitle:
      "يرجى قراءة هذه الشروط بعناية قبل استخدام منصة HealthAI. استمرارك في استخدام المنصة يعني موافقتك على هذه الشروط والأحكام.",
    ...
    sections: {
      acceptance: {
        title: "قبول الشروط",
        intro: "باستخدامك لمنصة HealthAI، فإنك:",
        items: [
      ...
      serviceDescription: {
        title: "وصف الخدمة",
        intro: "HealthAI تقدم الخدمات التالية:",
        items: [
      ...
      medicalDisclaimer: {
        ...
        warning: " HealthAI لا يقدم تشخيصاً طبياً أو علاجاً!",
        items: [
      ...
      intellectualProperty: {
        ...
        items: [
          "الشعارات والأسماء التجارية مملوكة لـ HealthAI",
  ...
  privacy: {
    ...
    subtitle:
      "يرجى مراجعة كيفية جمع HealthAI لبياناتك واستخدامها وتخزينها وحمايتها عند استخدام المنصة.",
    lastUpdatedLabel: "آخر تحديث:",
    sectionLabel: "القسم",
    sections: {
      ...
      medicalDisclaimer: {
        title: "إخلاء المسؤولية الطبية",
        strong:
          "هام: HealthAI أداة مساعدة ولا يغني عن الاستشارة الطبية المهنية.",
        items: [
